...
/**
 * > This class is a Spring controller that handles requests to the `/wallet` endpoint
 */
@RestController
...
public class WalletController {
	...
	/**
	 * It gets the wallet of the user who is logged in
	 * 
	...
	/**
	 * It adds money to the wallet of the user who is logged in
	 * 
	 * @param principal This is the user object that is passed by spring security.
	 * @param amount The amount to be added to the wallet.
	 * @param token This is the token that is generated by Stripe.js.
